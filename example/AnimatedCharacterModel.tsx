...
import { useEcctrlAnimationStore } from "ecctrl";

const readTimeScale = (value: number | React.RefObject<number>) => typeof value === "number" ? value : (value?.current ?? 1);

export default function AnimatedCharacterModel(props: any) {
