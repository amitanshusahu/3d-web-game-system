...
Command: npx gltfjsx@6.5.3 public/models/ignore/map/mobile_home_with_collider.glb -o src/components/Rendering/map/MovingHomeLatestGLBtoTSX.tsx 
*/
...
export function Model(props: JSX.IntrinsicElements['group']) {
  ...
  const { nodes, materials, animations } = useGLTF('/mobile_home_with_collider.glb') as GLTFResult
...
useGLTF.preload('/mobile_home_with_collider.glb')
